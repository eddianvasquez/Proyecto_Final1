    ...
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DireccionesDeEnvio", x => x.DireccionId);
                    table.ForeignKey(
                        name: "FK_DireccionesDeEnvio_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductoVariaciones", x => x.VariacionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pedidos_DireccionesDeEnvio_DireccionDeEnvioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DireccionesDeEnvio_UsuarioId",
                table: "DireccionesDeEnvio",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_Pedidos_DireccionDeEnvioId",
                table: "Pedidos",
                column: "DireccionDeEnvioId");
